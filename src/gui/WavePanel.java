...
public class WavePanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        statisticsWrap.setMeanValue(selectEndLine - selectStartLine == 0 ? -1 : total / (selectEndLine - selectStartLine) * xDelta);
    ...
    public List<Integer> getTotalValues() { return totalValues; }
