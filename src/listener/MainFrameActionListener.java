    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (command) {
            ...
            case "微分运算":
                if (wavePanelWrapList.get(MainFrame.statisticsPanel.getChannelChoosePanel().getSelectedIndex()).wavePanel.isVirtual())
                    return;
                List<Integer> differentialValue = DataProcess.differentialValue(wavePanelWrapList.get(MainFrame.statisticsPanel.getChannelChoosePanel().getSelectedIndex()).wavePanel.getTotalValues());
